...
public class LoadJoueur implements Runnable
{
	...
	public void run() 
	{
		if(running)
		{
			...
			System.out.println("infos sur le perso : " + str_perso);
			...
			network.sendToServer("lo;rc"); //load joueur, race caracteristiques
			network.waitForNewMessage();
			String s = network.getMessage_recu_serveur();
			System.out.println(s);
			String[] race_caract = s.split(";");
			...
			//Sorts de race
			network.sendToServer("lo;rs"); //load joueur, race sort
			network.waitForNewMessage();
			...
			network.sendToServer("lo;cc"); //load joueur, classe caracteristiques
			network.waitForNewMessage();
			...
			network.sendToServer("lo;jc"); //load joueur, joueur caracteristiques
			network.waitForNewMessage();
			...
			network.sendToServer("lo;jcv"); //load joueur, joueur caracteristiques values
			network.waitForNewMessage();
