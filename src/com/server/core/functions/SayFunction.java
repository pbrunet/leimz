...
public class SayFunction implements Functionable
{
    ...
    public void doSomething(String[] args,Client client)
    {
       ...
       if(args[2].equals("a"))	   
       		ServerSingleton.getInstance().sendAllClient(args[0]+";"+args[1]+";"+client.getCompte().getCurrent_joueur().getPerso().getNom()+";"+args[2]);
       else
    	   //ON chuchotte
    	   if(args[2].equals("w"))
    		   ServerSingleton.getInstance().getClient(args[2]).sendToClient(args[0]+";"+args[1]+";"+client.getCompte().getCurrent_joueur().getPerso().getNom()+";"+args[2]);
    	   else
    		   ServerSingleton.getInstance().sendAllClient(args[0]+";"+client.getCompte().getCurrent_joueur().getPerso().getNom()+";"+args[2]);
       			/* a finir
    		   ...
    		   if(args[1].equals("p"))
    		   {
    			   ...
    			   {
    				   c.sendToClient(args[0]+";"+args[1]+";"+client.getCompte().getCurrent_joueur().getPerso().getNom()+";"+args[2]);
    			   }
    		   }*/
    }
}
